...
- Inherit from `PetSafeExtendedEntity` and platform base class
...
- Entity: `custom_components/petsafe_extended/[platform]/[entity_name].py`
- Platform: `custom_components/petsafe_extended/[platform]/__init__.py`
