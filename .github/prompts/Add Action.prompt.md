...
**File:** `custom_components/petsafe_extended/services.yaml`
...
Create `custom_components/petsafe_extended/service_actions/[action_name].py`:

```python
"""[Action name] service action for PetSafe Extended."""
...
**File:** `custom_components/petsafe_extended/__init__.py`
...
**File:** `custom_components/petsafe_extended/const.py`
...
3. Find service action: `petsafe_extended.[action_name]`
...
- **Service actions directory:** `custom_components/petsafe_extended/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/petsafe_extended/services.yaml` (legacy filename)
- **Icons:** `custom_components/petsafe_extended/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/petsafe_extended/translations/*.json` under `services` key (legacy)
