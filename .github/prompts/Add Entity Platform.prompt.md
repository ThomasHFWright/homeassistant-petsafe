...
**Directory:** `custom_components/petsafe_extended/[platform]/`
...
```python
"""[Platform] platform for PetSafe Extended."""
...
from .entity import PetSafeExtendedEntity
from .[entity_file] import PetSafeExtended[EntityName]
...
async def async_setup_entry(
    ...
    coordinator: PetSafeExtendedDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            PetSafeExtended[EntityName](coordinator, entry),
...
```python
"""[Entity description] for PetSafe Extended."""
...
class PetSafeExtended[EntityName](
    PetSafeExtendedEntity,
    [PlatformEntityClass],
):
...
Add platform to `custom_components/petsafe_extended/manifest.json`:
...
- [ ] Entity class inherits from both `PetSafeExtendedEntity` and platform class
...
- **Base entity:** `PetSafeExtendedEntity` in `entity/base.py`
- **Coordinator:** `PetSafeExtendedDataUpdateCoordinator`
