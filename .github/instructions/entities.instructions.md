...
- **`entity/`** - Base entity classes (inherit `PetSafeExtendedEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, PetSafeExtendedEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import PetSafeExtendedEntity`
