...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `PetSafeExtended`
...
- Inherit from both platform entity and `PetSafeExtendedEntity` (order matters)
...
from custom_components.petsafe_extended.sensor import async_setup_entry
...
**Config entry data:** `entry_data: PetSafeExtendedData = hass.data[DOMAIN][entry.entry_id]`
