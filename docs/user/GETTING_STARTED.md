# Getting Started with PetSafe Extended

This guide will help you install and set up the PetSafe Extended custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/ThomasHFWright/homeassistant-petsafe`
6. Set category to "Integration"
7. Click "Add"
8. Find "PetSafe Extended" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/ThomasHFWright/homeassistant-petsafe/releases)
2. Extract the `petsafe_extended` folder from the archive
3. Copy it to `custom_components/petsafe_extended/` in your Home Assistant configuration directory
...
4. Select entities from "PetSafe Extended"
...
- Report issues at [GitHub Issues](https://github.com/ThomasHFWright/homeassistant-petsafe/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/ThomasHFWright/homeassistant-petsafe/discussions)
