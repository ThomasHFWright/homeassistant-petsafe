"""
API Client for petsafe_extended.
...
class PetSafeExtendedApiClientError(Exception):
    """Base exception to indicate a general API error."""


class PetSafeExtendedApiClientCommunicationError(
    PetSafeExtendedApiClientError,
):
    """Exception to indicate a communication error with the API."""


class PetSafeExtendedApiClientAuthenticationError(
    PetSafeExtendedApiClientError,
):
...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        PetSafeExtendedApiClientAuthenticationError: For 401/403 errors.
        aiohttp.ClientResponseError: For other HTTP errors.

    """
    if response.status in (401, 403):
        msg = "Invalid credentials"
        raise PetSafeExtendedApiClientAuthenticationError(
            msg,
        )
    response.raise_for_status()


class PetSafeExtendedApiClient:
    """
    ...
    async def async_get_data(self) -> Any:
        ...
        Raises:
            PetSafeExtendedApiClientAuthenticationError: If authentication fails.
            PetSafeExtendedApiClientCommunicationError: If communication fails.
            PetSafeExtendedApiClientError: For other API errors.
    ...
    async def _api_wrapper(
        ...
        try:
            ...
            raise PetSafeExtendedApiClientCommunicationError(
                msg,
            ) from exception
            ...
            raise PetSafeExtendedApiClientError(
                msg,
            ) from exception
