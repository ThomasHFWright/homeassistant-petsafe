"""
Core DataUpdateCoordinator implementation for petsafe_extended.
...
from custom_components.petsafe_extended.api import (
...
class PetSafeExtendedDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    async def _async_update_data(self) -> Any:
        ...
        except PetSafeExtendedApiClientAuthenticationError as exception:
            LOGGER.warning("Authentication error - %s", exception)
            raise ConfigEntryAuthFailed(
                translation_domain="petsafe_extended",
                translation_key="authentication_failed",
            ) from exception
        except PetSafeExtendedApiClientError as exception:
