"""
Custom integration to integrate petsafe_extended with Home Assistant.
...
https://github.com/ThomasHFWright/homeassistant-petsafe
...
from .data import PetSafeExtendedData
...
async def async_setup_entry(
    ...
    # Store runtime data
    entry.runtime_data = PetSafeExtendedData(
        client=client,
