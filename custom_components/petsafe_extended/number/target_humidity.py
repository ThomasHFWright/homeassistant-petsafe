"""Target humidity number for petsafe_extended."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.petsafe_extended.api import PetSafeExtendedApiClientError
...
class PetSafeExtendedHumidityNumber(NumberEntity, PetSafeExtendedEntity):
