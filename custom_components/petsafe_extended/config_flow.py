...
class ConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def get_devices(self, email: str, code: str):
        ...
        self._feeders = {x.api_name: x.friendly_name for x in await self._client.get_feeders()}
        self._litterboxes = {x.api_name: x.friendly_name for x in await self._client.get_litterboxes()}
        self._smartdoors = {x.api_name: x.friendly_name for x in await self._client.get_smartdoors()}
        return True
