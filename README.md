...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/ThomasHFWright/homeassistant-petsafe?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=homeassistant-petsafe&category=integration)
...
1. Download the `custom_components/petsafe_extended/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=petsafe_extended)
...
Find all entities in **Settings** → **Devices & Services** → **PetSafe Extended** → click on the device.
...
### `petsafe_extended.example_action`
...
```yaml
service: petsafe_extended.example_action
data:
  # Add your parameters here
```

### `petsafe_extended.reload_data`
...
```yaml
service: petsafe_extended.reload_data
```
...
logger:
  default: info
  logs:
    custom_components.petsafe_extended: debug
```
...
4. Check the integration diagnostics (Settings → Devices & Services → PetSafe Extended → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@ThomasHFWright][user_profile]**

---

[commits-shield]: https://img.shields.io/github/commit-activity/y/ThomasHFWright/homeassistant-petsafe.svg?style=for-the-badge
[commits]: https://github.com/ThomasHFWright/homeassistant-petsafe/commits/main
[hacs]: https://github.com/hacs/integration
[hacsbadge]: https://img.shields.io/badge/HACS-Default-orange.svg?style=for-the-badge
[license-shield]: https://img.shields.io/github/license/ThomasHFWright/homeassistant-petsafe.svg?style=for-the-badge
[maintenance-shield]: https://img.shields.io/badge/maintainer-%40ThomasHFWright-blue.svg?style=for-the-badge
[releases-shield]: https://img.shields.io/github/release/ThomasHFWright/homeassistant-petsafe.svg?style=for-the-badge
